...
var (
	...
	clusterRx     = regexp.MustCompile(`^(?:(?:|[a-z]-|ci[0-9]?-|st[0-9]?-|gh-actions-)?[a-z]{2}-[a-z]{2}-[0-9]|k-master)$`) // e.g. "qa-de-1" or "s-qa-de-1" or "ci-eu-de-2" or "st3-qa-de-1" or "gh-actions-eu-de-2" or "k-master"
